    ...
    return (
        <nav className='container'>
           ...
           <ul>
               ...
               <li onClick={uncheck}> <i className="far fa-file-alt"></i><a target="_blank" rel='noreferrer' href="https://drive.google.com/file/d/1q4__WeM1faZIwzqBAoUrIhp-2akqo78X/view?usp=sharing"> Resume </a> </li>
           </ul>
        </nav>
    )
}
